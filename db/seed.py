...
INITIAL_EXERCISES = [
    ...
    # Альтернативные упражнения — День A
    {"exercise_id": "deadlift_alt", "name": "Гиперэкстензия с весом", "day": "A", "order": 101,
     "category": "Спина", "weight_step": 2.5, "reps_min": 10, "reps_max": 12, "rest_seconds": 90, "default_sets": 3,
     "notes": "Блин к груди. До прямой линии — не выше. Пауза 1-2 сек вверху."},
    {"exercise_id": "bench_press_alt", "name": "Жим гантелей лёжа", "day": "A", "order": 102,
     "category": "Грудь", "weight_step": 2.5, "reps_min": 6, "reps_max": 8, "rest_seconds": 150, "default_sets": 4,
     "notes": "Лопатки сведены. Гантели к груди, выжимай сводя друг к другу."},
    {"exercise_id": "seated_cable_row_alt", "name": "Тяга гантели в наклоне", "day": "A", "order": 103,
     "category": "Спина", "weight_step": 2.5, "reps_min": 10, "reps_max": 12, "rest_seconds": 90, "default_sets": 3,
     "notes": "Одна рука и колено на скамье. Тяни к бедру. Каждая сторона."},
    {"exercise_id": "leg_extension_alt", "name": "Гоблет-присед", "day": "A", "order": 104,
     "category": "Ноги", "weight_step": 2.0, "reps_min": 12, "reps_max": 15, "rest_seconds": 60, "default_sets": 2,
     "notes": "Гантель у груди. Садись вниз, локти между коленей. Грудь вперёд."},
    {"exercise_id": "face_pull_alt", "name": "Разведение в наклоне", "day": "A", "order": 105,
     "category": "Плечи", "weight_step": 1.0, "reps_min": 15, "reps_max": 20, "rest_seconds": 60, "default_sets": 2,
     "notes": "Наклон 60-70°. Лёгкий вес. Сведи лопатки вверху."},
    {"exercise_id": "tricep_pushdown_alt", "name": "Французский жим с гантелей", "day": "A", "order": 106,
     "category": "Руки", "weight_step": 1.0, "reps_min": 12, "reps_max": 15, "rest_seconds": 60, "default_sets": 2,
     "notes": "Гантель за головой двумя руками. Локти вверх, прижаты к голове."},
    # Альтернативные упражнения — День B
    {"exercise_id": "hip_thrust_alt", "name": "Румынская тяга с гантелями", "day": "B", "order": 107,
     "category": "Ноги", "weight_step": 2.5, "reps_min": 10, "reps_max": 12, "rest_seconds": 90, "default_sets": 3,
     "notes": "Колени зафиксированы. Таз назад. Спина нейтральная."},
    {"exercise_id": "ohp_alt", "name": "Жим гантелей сидя", "day": "B", "order": 108,
     "category": "Плечи", "weight_step": 2.5, "reps_min": 6, "reps_max": 8, "rest_seconds": 120, "default_sets": 3,
     "notes": "Спинка 80-85°. Гантели на уровне ушей."},
    {"exercise_id": "lat_pulldown_alt", "name": "Подтягивания / гравитрон", "day": "B", "order": 109,
     "category": "Спина", "weight_step": 2.5, "reps_min": 8, "reps_max": 10, "rest_seconds": 90, "default_sets": 3,
     "notes": "Хват шире плеч. Тяни грудь к перекладине."},
    {"exercise_id": "leg_press_alt", "name": "Болгарский сплит-присед", "day": "B", "order": 110,
     "category": "Ноги", "weight_step": 2.5, "reps_min": 10, "reps_max": 12, "rest_seconds": 90, "default_sets": 2,
     "notes": "Задняя нога на скамье. Голень вертикальна. Через пятку."},
    {"exercise_id": "lateral_raise_alt", "name": "В кроссовере (в стороны)", "day": "B", "order": 111,
     "category": "Плечи", "weight_step": 1.0, "reps_min": 12, "reps_max": 15, "rest_seconds": 60, "default_sets": 2,
     "notes": "Боком к блоку. Дальняя рука тянет. Каждая сторона."},
    {"exercise_id": "bicep_curl_alt", "name": "Бицепс в блоке", "day": "B", "order": 112,
     "category": "Руки", "weight_step": 1.0, "reps_min": 12, "reps_max": 15, "rest_seconds": 60, "default_sets": 2,
